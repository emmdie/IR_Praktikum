...
# FAILED BECAUSE
"""
[frsc115a@login1.barnard martin]$ cat slurm-err/18095383.err 
OpenBLAS warning: precompiled NUM_THREADS exceeded, adding auxiliary array for thread metadata.
To avoid this warning, please rebuild your copy of OpenBLAS with a larger NUM_THREADS setting
or set the environment variable OPENBLAS_NUM_THREADS to 64 or lower
Fatal Python error: Segmentation fault

Thread 0x00007ffbebff7700 (most recent call first):
<no Python frame>

Thread 0x00007ffbddfdb700 (most recent call first):
<no Python frame>

Thread 0x00007ffbdbfd7700 (most recent call first):
<no Python frame>

Thread 0x00007ffbe8ff1700 (most recent call first):
<no Python frame>

Thread 0x00007ffbd8fd1700 (most recent call first):
<no Python frame>

...
srun: error: n1703: task 0: Segmentation fault
"""
...
def generate_fake_results_df() -> pd.DataFrame:
    data = [
        ...
        {"doc_id": 1568756722, "init_ranking": 38, "category": "Car", "cluster": 4, "text": "Das Auto hat keinen Tofu erlegt"},
        {"doc_id": 1828857682, "init_ranking": 28, "category": "puma", "cluster": 3, "text": "Eine Schuhmarke, hat nichts mit Jaguaren zu tun"},
